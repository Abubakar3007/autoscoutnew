                ...
                <div className="flex items-start gap-10">
                    ...
                    <div className="w-full">
                        ...
                        <div className="pt-10 mt-10 space-y-10 border-t border-neutral-400">
                            {/* dealer by list */}
                            <div>
                                <h4 class="mb-6 font-semibold">Dealer by list</h4>
                                {/* list */}
                                <div class="flex gap-6 text-blue-800 [&>.divider]:h-14 [&>.divider]:w-[1px] [&>.divider]:sm:block [&>.divider]:hidden [&>.divider]:bg-neutral-400 sm:items-center [&>ul]:flex-1 flex-wrap">
                                    <ul class="space-y-2 [&>li>a]:leading-6">
                            ...
                            {/* dealer by state */}
                            <div>
                                <h4 class="mb-6 font-semibold">Dealers by the state</h4>
                                {/* list */}
                                <div class="flex gap-6 text-blue-800 [&>.divider]:h-14 [&>.divider]:w-[1px] [&>.divider]:bg-neutral-400 [&>.divider]:sm:block [&>.divider]:hidden flex-wrap sm:items-center [&>ul]:flex-1">
                                    <ul class="space-y-2 [&>li>a]:leading-6">
