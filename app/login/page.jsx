                ...
                <div className="flex-1 w-full sm:rounded-md sm:p-6 sm:bg-white/10 sm:backdrop-blur-md max-w-538">
                    ...
                    <div className="p-4 rounded-md sm:p-6 bg-gray-50 shadow-box-shadow">
                        ...
                        <div className="flex mb-6 border-b border-neutral-400">
                            <button
                                className="flex-1 p-3 text-xl font-semibold border-b-2 border-blue-500 cursor-pointer active login-tab-btn"
                            >
                                Seller
                            </button>
                            <button
                                className="flex-1 p-3 text-xl font-semibold border-b-2 border-transparent cursor-pointer login-tab-btn"
                            >
                                Dealer
                            </button>
                        </div>
