        ...
        <div className="p-6 mb-10 rounded-md box shadow-box-shadow bg-white" data-ad="vehicle">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <CustomSelect data={brandData} name="brand" placeholder="Choose" />
                </div>

                {/* model */}
                <div>
                    <Label htmlFor="model" name="Model*" className="mb-1" />
                    <CustomSelect data={modelData} name="model" placeholder="Choose" />
                </div>
                ...
                <div className="col-span-2">
                    ...
                    <Input id="variant" placeholder="e.g.  B. Plus, GTI, 218, etc." />
                </div>
            </div>
        </div>
    )
